...
<head>
    ...
    <link rel="stylesheet" href="/cafeteriapdv/pagsperfis.css">
</head>
<body> 
    <div class="grid">
        <header class="header">
            ...
            <div class="botoes">
                ...
                <a href="/cafeteriapdv/Pagperfil2.html" class="botao-header"> Histórico de vendas</a>
                <a href="/cafeteriapdv/Pagperfil3.html" class="botao-header">Gestão de estoque</a>
            </div>
        </header>
